...
(
    ...
    CONSTRAINT email_validation_status_ak_1 UNIQUE (status) NOT DEFERRABLE INITIALLY IMMEDIATE,
    CONSTRAINT email_validation_status_pk PRIMARY KEY (id)
);
...
CREATE INDEX user_account_idx_1 ON user_account (email_validation_status_id ASC);

CREATE INDEX user_account_idx_2 ON user_account (role_id ASC);
...
-- Reference: user_email_validation_status (table: user_account)
ALTER TABLE user_account
    ADD CONSTRAINT user_email_validation_status
        FOREIGN KEY (email_validation_status_id)
            REFERENCES email_validation_status (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
;
